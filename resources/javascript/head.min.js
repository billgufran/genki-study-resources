!function(){if(window.__genkiBootstrapLoader)return;window.__genkiBootstrapLoader=!0;var e=document.head||document.getElementsByTagName('head')[0];function n(){var n=document.createElement('script');n.type='module',n.src='/resources/javascript/modules/bootstrap.js',e.appendChild(n)}function o(){if(window.supabase)return n();var o=document.createElement('script');o.src='https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2.75.0/dist/umd/supabase.min.js',o.onload=n,o.onerror=function(){console.error('Failed to load Supabase library.')},e.appendChild(o)}(function(){var n=document.createElement('script');n.src='/resources/javascript/config.js',n.onload=o,n.onerror=function(){console.warn('Missing config.js; loading example config.');var n=document.createElement('script');n.src='/resources/javascript/config.example.js',n.onload=o,n.onerror=o,e.appendChild(n)},e.appendChild(n)})()}();
